 ...
 * @returns {string}
 */
export function buildAIPolicyTier1Prompt({ name, party, state, office, knownPositions, bigTechDonations, aiBills, datacenterInfo }) {
...
AI bill cosponsorships: ${billsText}
